    ...
    <div className="min-h-screen bg-[var(--color-page)] flex flex-col">
      ...
      <div className="flex-1 flex items-start justify-center px-4 py-14">
        {checking ? (
          ...
          <div className="w-full max-w-[440px] rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] p-8 shadow-[var(--shadow-sm)] text-center">
            <div className="mx-auto w-24 h-24 rounded-full border-2 border-[var(--color-border)] bg-[var(--color-primary-soft)] overflow-hidden flex items-center justify-center">
